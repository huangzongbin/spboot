    ...
    <div class="layui-row">
        <form class="layui-form layui-form-pane" id="useaddform">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="username" lay-verify="username" autocomplete="off" placeholder="请输入标题"
                           class="layui-input">
                </div>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="password" autocomplete="off" placeholder="请输入密码" lay-verify="password"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">重新确定密码</label>
                <div class="layui-input-inline">
                    <input type="text" name="" id="repassword" autocomplete="off" placeholder="请输入密码"
                           lay-verify="repassword" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="address" id="address" placeholder="请输入地址" width="200px" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="phone" placeholder="电话号码" width="200px" autocomplete="off"
                           class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <select name="roleId" lay-filter="aihao">
                        ...
                        <option value="4" selected="">员工</option>
                    </select>
                </div>
            </div>
